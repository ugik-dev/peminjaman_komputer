...
<head>
    ...
    <title>POLMAN BABEL |Ecommerce Dashboard
    </title>
    <!-- shortcut icon-->
    <link rel="icon" href="http://localhost/app_peminjaman/assets/images/logo/icon-logo.png" type="image/x-icon">
    <link rel="shortcut icon" href="http://localhost/app_peminjaman/assets/images/logo/icon-logo.png" type="image/x-icon">
    <!-- Fonts css-->
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Rubik:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,300;1,400;1,500;1,600;1,700;1,800;1,900&amp;display=swap" rel="stylesheet">
    <!-- Font awesome -->
    <link href="http://localhost/app_peminjaman/assets/css/vendor/font-awesome.css" rel="stylesheet">
    <!-- themify icon-->
    <link href="http://localhost/app_peminjaman/assets/css/vendor/themify-icons.css" rel="stylesheet">
    <!-- Slick slider-->
    <!-- <link href="http://localhost/app_peminjaman/assets/css/vendor/slider/slick-slider/slick.css" rel="stylesheet">
    <link href="http://localhost/app_peminjaman/assets/css/vendor/slider/slick-slider/slick-theme.css" rel="stylesheet"> -->
    <!-- Scrollbar-->
    <link href="http://localhost/app_peminjaman/assets/css/vendor/simplebar.css" rel="stylesheet">
    <!-- Bootstrap css-->
    <link href="http://localhost/app_peminjaman/assets/css/vendor/bootstrap.css" rel="stylesheet">
    <!-- Custom css-->
    <link href="http://localhost/app_peminjaman/assets/css/style.css" id="customstyle" rel="stylesheet">

    <script src="http://localhost/app_peminjaman/assets/js/jquery-3.6.0.js"></script>
    <script src="http://localhost/app_peminjaman/assets/js/custom.js"></script>

    <script src="http://localhost/app_peminjaman/assets/js/plugins/sweetalert/sweetalert2.all.min.js"></script>
    <!-- Data table -->
    ...
    <!--Datatable-->
    <link href="../assets/css/vendor/datatable/jquery.dataTables.css" rel="stylesheet" />
    <link href="../assets/css/vendor/datatable/buttons.dataTables.css" rel="stylesheet" />
    <link href="../assets/css/vendor/datatable/custom-datatable.css" rel="stylesheet" />
    ...
    <script src="http://localhost/app_peminjaman/assets/js/FileUploader.js"></script>
</head>
    ...
    <aside class="codex-sidebar">
        ...
        <div class="codex-menuwrapper">
            <ul class="codex-menu custom-scroll" data-simplebar>
                ...
                <a href="http://localhost/app_peminjaman/mahasiswa/riwayat"><i class="fa fa-history"></i> <span class="nav-label">Riwayat</span></a>
            </li>
            <li id="logout">
                <a href="http://localhost/app_peminjaman/AdminController" class="logout"><i class="fa fa-sign-out"></i> <span class="nav-label">Logout</span></a>
            </li> -->

                <!-- <li class="menu-item"><a href="index.html">
                    <div class="icon-item"><i data-feather="home"></i></div><span>default</span>
                </a></li> -->
                <li class="menu-item"><a href="http://localhost/app_peminjaman/mahasiswa/riwayat">
                ...
                <li class="menu-item"><a href="http://localhost/app_peminjaman/logout">
    ...
    <div class="themebody-wrap">
        ...
        <div class="theme-body" data-simplebar>
            <div class="custom-container element-button">
                ...
                <script src="http://localhost/app_peminjaman/assets/js/jquery-3.6.0.js"></script>
                <!-- Theme Customizer-->
                <script src="http://localhost/app_peminjaman/assets/js/layout-storage.js"></script>
                <script src="http://localhost/app_peminjaman/assets/js/customizer.js"></script>
                <!-- Feather icons js-->
                <script src="http://localhost/app_peminjaman/assets/js/icons/feather-icon/feather.js"></script>
                <!-- Bootstrap js-->
                <script src="http://localhost/app_peminjaman/assets/js/bootstrap.bundle.min.js"></script>
                <!-- Scrollbar-->
                <script src="http://localhost/app_peminjaman/assets/js/vendors/simplebar.js"></script>
                <!-- apex chart-->
                <!-- <script src="http://localhost/app_peminjaman/assets/js/vendors/chart/apexcharts.js"></script> -->
                <!-- ecommerce dashboard-->
                <!-- <script src="http://localhost/app_peminjaman/assets/js/dashboard/ecommerce.js"></script> -->
                <!-- slick slider-->
                <script src="http://localhost/app_peminjaman/assets/js/vendors/slider/slick-sldier/slick.min.js"></script>
                <!-- <script src="http://localhost/app_peminjaman/assets/js/vendors/slider/slick-sldier/slick-custom.js"></script> -->
                <!-- Custom script-->
                <script src="http://localhost/app_peminjaman/assets/js/custom-script.js"></script>
