         ...
         <li class="nav-profile">
           ...
           <div class="hover-dropdown navprofile-drop">
             <ul>
               ...
               <li><a id="password_btn"><i class="ti-settings"></i>ganti password</a></li>
               <li><a id="photo_btn"><i class="fa fa-photo"></i>ganti Photo</a></li>
               <?php

                if ($this->session->userdata('id_role') == 4) {
                  echo '     <li><a href="' . base_url('mahasiswa/profile') . '"><i class="ti-user"></i>Profile</a></li>';
                } else {
                  echo '     <li><a id="profile_btn"><i class="ti-user"></i>Profile</a></li>';
                }  ?>
               <!-- <li><a id="profile_btn"><i class="ti-user"></i>Profile</a></li> -->
