  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content animated fadeIn">
      <div class="modal-header">
        <h4 class="modal-title">Kelola Mahasiswa</h4>
      ...
      <div class="modal-body" id="modal-body">
        <form role="form" id="user_form" onsubmit="return false;" type="multipart" autocomplete="off">
          ...
          <div class="form-group">
            ...
            <input type="text" placeholder="NIM" class="form-control" id="username" name="username" required="required">
          </div>
          <div class="form-group">
  ...
  $(document).ready(function() {
    ...
    function renderKelolahuser(data) {
      ...
      Object.values(data).forEach((user) => {
        var detailButton = `
        <li>
      <a class="detail dropdown-item" href='<?= site_url() ?>AdminController/DetailMahasiswa/${user['id_user']}'><i class='fa fa-share'></i> Detail</a>
      </li>
      `;
        var editButton = `
        <li>
      ...
      `;
        renderData.push([user['username'], user['nama'], user['nama_jurusan'], statusData(user['status_data']), button]);
      });
