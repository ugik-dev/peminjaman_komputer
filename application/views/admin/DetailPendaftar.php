        ...
        <form id="preForm" class="m-t" role="form">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Nama</label>
                        <input type="text" value="<?= !empty($ret_data['nama']) ? $ret_data['nama'] : '' ?>" class="form-control" disabled="disabled" autocomplete="username">
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" value="<?= !empty($ret_data['username']) ? $ret_data['username'] : '' ?> " class="form-control" disabled="disabled" autocomplete="username">
                    </div>
                </div>
            ...
            <div class="form-group">
                ...
                <textarea rows="4" type="text" class="form-control" id="alamat_sekolah" name="alamat_sekolah" required="required"><?= !empty($ret_data['alamat_sekolah']) ? $ret_data['alamat_sekolah'] : '' ?></textarea>
            </div>
            <hr>
            <div class="col-md-6 mb-2">
                <div class="form-group">
                    <label>File KTP<small style="color: red"> *max 300kb</small></label>
                    <input type="file" class="form-control" id="file_ktp" name="file_ktp" <?= empty($ret_data['file_ktp']) ? ' required="required"' : '' ?>>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        preForm.submit(function(ev) {
            ...
            $.ajax({
                url: "<?= base_url() . 'AdminController/edit_data_pendaftar' ?>",
                type: "POST",
